...
namespace protobuf_SearchRequest_2eproto {
...
enum Corpus {
  ...
  PRODUCTS = 5,
  VIDEO = 6,
  Corpus_INT_MIN_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32min,
  Corpus_INT_MAX_SENTINEL_DO_NOT_USE_ = ::google::protobuf::kint32max
};
bool Corpus_IsValid(int value);
const Corpus Corpus_MIN = UNIVERSAL;
const Corpus Corpus_MAX = VIDEO;
const int Corpus_ARRAYSIZE = Corpus_MAX + 1;

const ::google::protobuf::EnumDescriptor* Corpus_descriptor();
inline const ::std::string& Corpus_Name(Corpus value) {
  return ::google::protobuf::internal::NameOfEnum(
    Corpus_descriptor(), value);
}
inline bool Corpus_Parse(
    const ::std::string& name, Corpus* value) {
  return ::google::protobuf::internal::ParseNamedEnum<Corpus>(
...
class SearchRequest : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:SearchRequest) */ {
 ...
 private:
  ...
  friend struct ::protobuf_SearchRequest_2eproto::TableStruct;
  friend void ::protobuf_SearchRequest_2eproto::InitDefaultsSearchRequestImpl();
};
// ===================================================================
...
inline ::Corpus SearchRequest::corpus() const {
  // @@protoc_insertion_point(field_get:SearchRequest.corpus)
  return static_cast< ::Corpus >(corpus_);
}
inline void SearchRequest::set_corpus(::Corpus value) {
...
template <> struct is_proto_enum< ::Corpus> : ::google::protobuf::internal::true_type {};
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::Corpus>() {
